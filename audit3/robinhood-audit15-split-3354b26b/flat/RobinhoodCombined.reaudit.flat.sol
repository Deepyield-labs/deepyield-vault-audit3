...
contract BoundedMorphoV2Adapter is ReentrancyGuard {
    ...
    function park(
        ...
        // Read what the bundle actually consumed BEFORE resetting the approval.
        // Reading it afterwards could only ever observe our own reset, so the
        // check could never fire and an under-consuming bundle would still
        // credit the full requested amount to the cost basis.
